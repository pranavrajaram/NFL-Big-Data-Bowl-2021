...
one_week_data = read_csv("~/nfl-big-data-bowl-2021/week5.csv")
plays_data = read_csv("~/nfl-big-data-bowl-2021/plays.csv")

plays_data %>%
  filter(gameId == 2018100400) %>% View()

one_week_data %>%
  filter(displayName == "Josh Gordon") %>% View()
...
generate_play(game = 2018100400, play = 3647)
